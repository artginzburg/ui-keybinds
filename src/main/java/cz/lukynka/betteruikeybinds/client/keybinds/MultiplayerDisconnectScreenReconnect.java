...
public class MultiplayerDisconnectScreenReconnect implements Keybind {
    ...
    public void handle(Integer key) {
        ...
        if (lastConnectedServerData != null) {
            ConnectScreen.startConnecting(screen, Minecraft.getInstance(), ServerAddress.parseString(lastConnectedServerData.ip), lastConnectedServerData, false, (TransferState) null);
        }
    }
}
